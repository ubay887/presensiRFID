                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4 col-12">
                                <label>ID Chat</label>
                                <input type="text" class="form-control" value="@if (is_numeric($id->idchat)) {{ $id->idchat }}@else- @endif"
                                readonly>
                            </div>
                            <div class="form-group col-md-4 col-12">
                                <label>NIPD</label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4 col-12">
                                ...
                                <input type="text" class="form-control" value="@if ($id->created_at) {{ \Carbon\Carbon::parse($id->created_at)->format('d F Y') }}@else- @endif"
                                readonly>
                            </div>
                            <div class="form-group col-md-4 col-12">
                                <label>Tanggal Diperbaharui</label>
                                <input type="text" class="form-control" value="@if ($id->updated_at) {{ \Carbon\Carbon::parse($id->updated_at)->format('d F Y') }}@else- @endif"
                                readonly>
                            </div>
                            <div class="form-group col-md-4 col-12">
