...
@endsection
@section('main')
    <h2 class="section-title">Hi, {{ Auth::guard('siswa')->user()->nama }}!</h2>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-4 col-12">
                            <label>ID Chat</label>
                            <input type="text" class="form-control" value="{{ Auth::guard('siswa')->user()->idchat }}"
                        ...
                        <div class="form-group col-lg-8 col-md-4 col-12">
                            ...
                            <input type="text" class="form-control" value="{{ Auth::guard('siswa')->user()->nama }}"
                    ...
                    <div class="row">
                        <div class="form-group col-md-5 col-12">
                            ...
                            <input type="text" class="form-control" value="{{ Auth::guard('siswa')->user()->username }}"
                                autocomplete="off" name="username">
                        </div>
                        <div class="form-group col-md-7 col-12">
                            <label>Email</label>
                            <input type="email" class="form-control" value="{{ Auth::guard('siswa')->user()->email }}"
                                required="">
                            <div class="invalid-feedback">
