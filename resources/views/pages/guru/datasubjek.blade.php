                ...
                <div class="card">
                    <div class="row mt-3 mx-3 d-flex justify-content-lg-between ">
                        <div class="col-8">
                            <button href="#" class="btn btn-success mr-3" data-toggle="modal" data-target="#modal2"><i
                                    class="fa fa-user-plus"></i> Tambah Subjek</button>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTables" class="table table-striped dataTable no-footer" style="width:100%"
                                role="grid">
                                <thead>
                                    <tr role="row">
                                        <th scope="col-1">
                                ...
                                <tbody>
                                    <tr role="row">
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="#" class="btn btn-primary mr-2" data-toggle="tooltip"
                                                data-placement="top" title="" data-original-title="Edit"><i
                                                    class="ph-note-pencil-bold"></i></a>
