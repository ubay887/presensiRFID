...
@endsection
@section('main')
    <a href="{{ url('guru/presensi') }}" class="btn btn-light"><i class="fa fa-caret-left"></i> Kembali</a>
    <div class="container-fluid mt-3">
        @csrf
        <p class="font-italic">
            H = <span class="font-weight-bold">Hadir</span>; S = <span class="font-weight-bold">Sakit</span>; I = <span
                class="font-weight-bold">Izin</span>; A = <span class="font-weight-bold">Alfa</span>; <br> B = <span
                class="font-weight-bold">Bolos</span>; L = <span class="font-weight-bold">Lupa Tap</span>; T = <span
                class="font-weight-bold">Terlambat</span>; P = <span class="font-weight-bold">Pulang Cepat</span>;
        </p>
        <div class="card">
            <div class="row mt-3 mx-3 d-flex justify-content-lg-between">
                ...
                <div class="col-lg-auto d-flex justify-content-between">
                    ...
                    <a href="#">
                        <button class="btn btn-info mr-3"><i class="fa fa-database"></i>
                            Detail</button>
                    </a>
