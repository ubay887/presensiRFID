            ...
            <form method="post" class="needs-validation" enctype="multipart/form-data" action="profile/update">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-4 col-12">
                            <label>Id Chat</label>
                            <input type="text" class="form-control" value="{{ Auth::user()->id_chat }}" required
                                name="idchat">
                    ...
                    <div class="row">
                        <div class="form-group col-md-5 col-12">
                            ...
                            <input type="text" class="form-control" value="{{ Auth::user()->username }}" autocomplete="off"
                                name="username">
                        </div>
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('/profile/changepassword') }}" class="btn text-white"
                        style="background-color: #6777EF">change password</a>
